/*******************************************************************************
purpose: 		evaluate linkage for the preterm LCPUFA RCT
date 
created: 		02/04/2019
...
********************************************************************************
*                            keep only those from trial 4                      *
********************************************************************************
keep if		trial==4
count if	trial==4 //311
tab			group, m 
...
count if	pupilreference==. // 2
count if	studyid1=="" // 0
egen		rct4_avg1stacyr = mean(first_acyr)
lab var		rct4_avg1stacyr "RCT 4 average first academic year"


********************************************************************************
*                 are there any study ID duplicates?                           *
********************************************************************************
count if	dup_studyid>0 & dup_studyid !=. // yes there are ----50---- duplicate study IDs
count if	studyid1=="" // 0
...
egen		rct4_avgage1stlink = mean(firstagelink)
lab var		rct4_avgage1stlink "RCT 4 average first age at link"
...
replace		truematch =1 if (fnscore ==1 | fnscore ==2 | fnscore ==3 ) & snscore==3 & (locationscore ==1 | locationscore ==2) &  first_acyr >1997 & first_acyr <2015 // LC preterm
replace		truematch =1 if (fnscore ==1 | fnscore ==2 | fnscore ==3 ) & snscore==3 & dbscore ==1 & first_acyr >1997 & first_acyr <2015 // LC preterm
replace		truematch =1 if (fnscore ==1 | fnscore ==2 | fnscore ==3 ) & (locationscore ==1 | locationscore ==2) & dbscore ==1 & first_acyr >1997 & first_acyr <2015 // LC preterm
replace		truematch =1 if snscore==3 & (locationscore ==1 | locationscore ==2) & dbscore ==1 & first_acyr >1997 & first_acyr <2015 // LC preterm
