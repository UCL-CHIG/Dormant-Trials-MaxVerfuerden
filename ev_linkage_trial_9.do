/*******************************************************************************
purpose: 		evaluate linkage for the palmitate RCT
date 
created: 		03/04/2019
...
********************************************************************************
*                            keep only those from trial 9                      *
********************************************************************************
keep if		trial==9
count if	trial==9 //517
tab			group, m 
...
********************************************************************************
count if	dup_studyid>0 & dup_studyid !=. // yes there are ----29---- duplicate study IDs
count if	studyid1=="" // 0
...
egen		rct9_avgage1stlink = mean(firstagelink)
lab var		rct9_avgage1stlink "RCT 9 average first age at link"
...
replace		truematch =1 if (fnscore ==1 | fnscore ==2 | fnscore ==3 ) & snscore==3 & (locationscore ==1 | locationscore ==2) & first_acyr >1999 & first_acyr <2015 // Palmitate
replace		truematch =1 if (fnscore ==1 | fnscore ==2 | fnscore ==3 ) & snscore==3 & dbscore ==1 & first_acyr >1999 & first_acyr <2015 // Palmitate
replace		truematch =1 if (fnscore ==1 | fnscore ==2 | fnscore ==3 ) & (locationscore ==1 | locationscore ==2) & dbscore ==1 & first_acyr >1999 & first_acyr <2015 // Palmitate
replace		truematch =1 if snscore==3 & (locationscore ==1 | locationscore ==2) & dbscore ==1 & first_acyr >1999 & first_acyr <2015 // Palmitate
...
*by academic year
replace		falsematch =1 if first_acyr <2000 | (first_acyr >2014 & first_acyr !=.)
replace		falsematch =1 if last_acyr <2000 | (last_acyr >2015 & last_acyr !=.)
