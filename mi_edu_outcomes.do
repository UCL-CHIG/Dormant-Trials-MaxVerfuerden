...
purpose: 	Creates analysis dataset,
		...
		and Performs multiple imputation for school outcomes 
date created: 	02/07/2019
last updated: 	04/05/2020 - added allocation variable
		...
		16/07/2020 - interaction terms: add description of how imputation was done for the interaction terms (using the , by(var) option)
...
/* 			for interactions: use  same model but using, by(smokdur) or by(sex) from https://www.ssc.wisc.edu/sscc/pubs/stata_mi_models.htm#InteractionTerms */
